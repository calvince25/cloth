...
export default function Dashboard() {
  ...
  const statCards = [
    ...
    { title: 'Blog Posts', value: stats.blogs, icon: FileText, color: 'text-purple-500', bg: 'bg-purple-50' },
    { title: 'Registered Users', value: stats.users, icon: Users, color: 'text-orange-500', bg: 'bg-orange-50' },
    { title: 'Contact Messages', value: stats.messages, icon: MessageSquare, color: 'text-green-500', bg: 'bg-green-50' },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {statCards.map((stat, i) => (
          <motion.div
            ...
            className="bg-white p-6 shadow-sm border border-gray-100 rounded-sm flex items-center justify-between"
          >
            <div>
